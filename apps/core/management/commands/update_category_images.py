...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        ...
        category_image_mapping = {
            ...
            'videokonferentsterminaly': 'video-conference.svg',
            'vnutrennie-led-ekrany': 'video-walls.svg',
            'diskussionnye-sistemy': 'audio-systems.svg',
            'interaktivnye-paneli': 'interactive-devices.svg',
            'kamery-dlya-vks': 'cameras.svg',
            'kontrollery-dlya-led': 'video-walls.svg',
            'meditsinskie-monitory': 'video-walls.svg',
            'monitory-dlya-videonablyudeniya': 'video-walls.svg',
            'nastolnye-mikrofony': 'microphones.svg',
            'petlichnye-mikrofony': 'microphones.svg',
            'resheniya-dlya-peregovornyh-komnat': 'meeting-rooms.svg',
            'ruchnye-mikrofony': 'microphones.svg',
            'sistemy-golosovaniya': 'audio-systems.svg',
            'ulichnye-led-ekrany': 'video-walls.svg',
        }
